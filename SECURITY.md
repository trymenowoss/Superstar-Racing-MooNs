...
Do not disclose access tokens, invitation links, passwords, private IP details beyond those already shipped in the client, or security vulnerabilities in a public GitHub issue.
...
- Compare the downloaded ZIP's SHA-256 checksum with the checksum published in its GitHub release notes.
